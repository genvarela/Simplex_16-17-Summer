...
public:
	bool rotating; //Keeps track of whether or not the mesh is rotating - talks between AppClassControls.cpp and AppClass.cpp
	//std::vector<vector3> v3Stop; //moved here from AppClassMain.cpp, but breaks the code
